    ...
    <head>
        ...
        <style type="text/css">
            *{margin:0;padding:0;-webkit-box-sizing: border-box;-moz-box-sizing: border-box;box-sizing: border-box;}
                ...
                table{width: 100%;}
                .heading{background-color: rgb(68, 68, 68);border-top: 3px solid #1169b4;color: #fff;padding: 20px 0;text-align: center;margin-bottom: 5px;}
                .heading h1{font-size: 22px;}
                .container {display:block!important;max-width:600px!important;margin:0 auto!important;clear:both!important;}
                .body-wrap .container{background-color: #ccc;border:1px solid #c1c1c1;box-shadow: 0 0 0 1px rgba(0,0,0,0.06);padding: 15px;min-width:100%!important}
        	...
        	<tr>
                <td class="container">
                    <table>
                        <tr>
                            <td>
                                <h1><img src="{{Url('/')}}/front/images/logo.png"><br>New Contact Request From : {{Url('/')}}</h1>
                            </td>
                        </tr>
                    </table>
                </td>
