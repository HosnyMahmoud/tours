...
{!! Form::select('users_id[]', @$users, null, ['id' => 'id_label_multiple', 'class' => 'js-example-basic-multiple js-states form-control','selected'=>'selected' ,'placeholder','اختر من هذة القائمة ']) 
!!}
